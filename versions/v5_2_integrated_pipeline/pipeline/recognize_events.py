...
def parse_args():
    ...
    parser.add_argument("--timing-search-seconds", type=float, default=0.10)
    parser.add_argument("--timing-fit-seconds", type=float, default=0.10)
    parser.add_argument("--timing-min-gain", type=float, default=0.060)
    parser.add_argument("--timing-max-confidence-for-shift", type=float, default=0.60)
    parser.add_argument("--timing-min-interval-width", type=int, default=2)
...
def main() -> None:
    ...
    if not args.disable_contact_timing_refinement:
        events = refine_contact_timing(
            ...
            court_tracks,
            fps,
            search_seconds=args.timing_search_seconds,
            fit_seconds=args.timing_fit_seconds,
            min_gain=args.timing_min_gain,
            max_confidence_for_shift=args.timing_max_confidence_for_shift,
            min_interval_width=args.timing_min_interval_width,
        )
